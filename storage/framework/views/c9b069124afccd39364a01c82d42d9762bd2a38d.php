...
<html lang="en" class="light">
   ...
   <head>
      ...
      <link href="<?php echo e(asset('src/images/icon.png')); ?>" rel="shortcut icon">
...
<?php echo HTML::style('dist/css/app.css'); ?>
...
<?php echo HTML::script("assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js"); ?>
   ...
   <script>
	...
	<script>
      ...
      $(document).ready(function() { var max_fields = 10; var wrapper = $(".AddMorePackageslcl"); var add_button = $(".AddMorePackages"); var x = 1; $(add_button).click(function(e){ e.preventDefault(); if(x < max_fields){ x++; $(wrapper).append('<div class="col-span-6"><label for="regular-form-1" class="form-label">Select Package</label><select id="regular-form-1" class="lcl_packages form-select sm:mr-2" aria-label="Default select example" name="lcl_package[]"> <option> Select Package </option> <?php if(!empty($lcl_packeges)): ?><?php $__currentLoopData = $lcl_packeges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packege): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($packege->id); ?>"> <?php echo e($packege->packagename); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?> </select></div><div class="col-span-6"></div><div class="lcl_entrustation_details_view" style="width:100%; grid-column: span 12 / span 12"><table id="customTable"><thead><tr></tr></thead><tbody class="new_entry"></tbody></table></div>'); }});
   ...
   <script>
      ...
      $(document).ready(function() { var max_fields = 10; var wrapper = $(".AddMorePackagesfcl"); var add_button = $(".AddMorePackages_fcl"); var x = 1; $(add_button).click(function(e){ e.preventDefault(); if(x < max_fields){ x++; $(wrapper).append('<div class="col-span-6"><label for="regular-form-1" class="form-label">Select Package</label><select id="regular-form-1" class="packages form-select sm:mr-2" aria-label="Default select example" name="package[]"> <option> Select Package </option> <?php if(!empty($packeges)): ?><?php $__currentLoopData = $packeges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packege): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($packege->id); ?>"> <?php echo e($packege->packagename); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?> </select></div><div class="col-span-6"><button type="button" class="btn_remove btn-danger mt-5">Remove</button></div></div><div class="station_details_view" style="width:100%; grid-column: span 12 / span 12"><table id="customTable"><thead><tr></tr></thead><tbody class="new_entry"></tbody></table></div>'); }});
...
<?php echo $__env->yieldContent('jquery_validation'); ?>
...
<?php /**PATH H:\xamp_7.2.5\htdocs\projects\software2\sms\resources\views/layouts/master.blade.php ENDPATH**/ ?>