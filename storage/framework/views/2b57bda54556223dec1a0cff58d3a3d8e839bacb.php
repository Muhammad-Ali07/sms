                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            ...
                            <div id="input" class="p-5">
                                <form method="POST" action="<?php echo e(route('update-user-permissions')); ?>" id="update-permission-form">
                                    <?php echo csrf_field(); ?>
                                    <div class="preview">
                                        <div class="mt-2">
                                    ...
                                    <?php $__currentLoopData = $data['permissions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="intro-y box col-lg-6 mt-3">
                                            ...
                                            <div class="preview box-shadow">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <?php if(is_array($permissions)): ?> <!-- Check if permissions is an array -->
                                                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subGroupName => $subPermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    <td class="group-name"><?php echo e($subGroupName); ?></td>
                                                                    <?php $__currentLoopData = $subPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <td>
                                                                            <input type="checkbox" class="permission-checkbox" name="per[]" value="<?php echo e($p->name); ?>" data-permission="<?php echo e($p->name); ?>" />
                                                                        </td>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php else: ?>
                                                            <tr>
                                                                <td class="group-name"><?php echo e($groupName); ?></td>
    ...
    <script>
        ...
        $(".addmoreproducts").click(function() {
            ...
            $(".productsaddmore").append('<div class="' + x + 'remeve">' + button +
                '<div class="mt-2"><label for="regular-form-2" class="form-label">Item Name</label><input  id="regular-form-2" name="Items[]" type="text" <?php if(!empty($query)): ?> value="<?php echo e($query->Des); ?>" <?php endif; ?> class="form-control" placeholder="Product Name"><div class="col-span-4 positon-relative"><button data-id="' +
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xamp_7.2.5\htdocs\projects\software2\sms\resources\views/setting/user_management_system/form.blade.php ENDPATH**/ ?>