                     ...
                     <div class="intro-y box">
                        ...
                        <div class="row w-full">
                            ...
                            <div class="col-lg-6 d-flex justify-content-end">
                                <p class="float-right"><b><?php echo e(isset($code) ? $code : 'BL-0001'); ?></b></p>
                            </div>
                        </div>
                        ...
                        <div id="input" class="p-5" style="padding-bottom: 65px;">
                           ...
                           <div class="preview">
                             ...
                             <input type="hidden" name="selfcompany" value="<?php echo e(session('company')[0]->id); ?>" />

                              <div class="mt-2">
                                   <label  class="form-label col-md-4 col-sm-4 col-xs-12" >Enter Bill Number:</label>
                                   <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="hidden" name="bill_code" value="<?php echo e($code); ?>" id="bill_code">
                                         <input type="number" name="bill_number" readonly id="bill_num" class="form-control col-md-7 col-xs-12" value="<?php echo e($billNum); ?>"/>
                                   </div>
                              </div>
                              ...
                              <div class="mt-2">
                                   ...
                                   <div class="col-md-8 col-sm-8 col-xs-12">
                                     ...
                                     <select class="form-control col-md-7 col-xs-12" id="customer" name="customer">
                                       ...
                                       <?php $__currentLoopData = $sender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                       <option value="<?php echo e($customer->id); ?>" <?php if(isset($record[0]->fk_sender_id)){if($record[0]->fk_sender_id == $customer->id){echo 'selected';}}?>><?php echo e($customer->name); ?></option>
                              ...
                              <div class="mt-2" id="fuelCharge" style="display: none;">
                                 ...
                                 <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="mt-2" id="taxpercentage" style="display: none;">
                                        ...
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                            <input type="text" name="taxpercentage[]" placeholder="Tax perecentage..." class="form-control col-md-7 col-xs-12" />
                                    ...
                                    <div class="mt-2" id="taxname_2" style="display: none;">
                                        <label class="form-label col-md-4 col-sm-4 col-xs-12" >Tax Name</span></label>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                            <input type="text" name="taxname[]" placeholder="Tax name..." class="form-control col-md-7 col-xs-12" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2" id="taxpercentage_2" style="display: none;">
                                         <label class="form-label col-md-4 col-sm-4 col-xs-12">Tax%</label>
                                         <div class="col-md-8 col-sm-8 col-xs-12">
                                             <input type="text" name="taxpercentage[]" placeholder="tax percentage..." class="form-control col-md-7 col-xs-12" />
                                          </div>
                                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="hidden" name="generatedby" value="<?php echo e($name); ?>" />
                                ...
                                <script>
                                    $('#generateBillButton').on('click', function(event) {
                                            ...
                                            // Prepare the data to be sent
                                                ...
                                                $.ajax({
                                                    url: '<?php echo e(url('generate-bill')); ?>', // Form action URL
                                                    type: 'POST',
                                                    data: formData,
                                ...
                                <script>
                                    $(document).ready(function() {
                                        $('#getDetailBtn').on('click', function() {
                                            ...
                                            $.ajax({
                                                url: '<?php echo e(route('get.details')); ?>',  // Laravel route helper
                                                method: 'POST',
                                                data: formData,
                                                 headers: {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    ...
                                                    let modalBodyContent = `
                                                        ...
                                                        <div class="card">
                                                            <!-- Card Header -->
                                                            <div class="card-header mb-3" style="background: #ffe9e9">
                                                                <h3 class="custom-icon-color"><i class="fa fa-file-text"></i> Builty Information</h3>
                                                            </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-truck"></i> Builty ID:</strong>
                                                                        <span>${response.builty_id}</span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-calendar"></i> Date:</strong>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-user"></i> Customer Name:</strong>
                                                                        <span>${response.customer_name}</span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-user"></i> Manager Name:</strong>
                                                                        <span>${response.manager_name}</span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-laptop"></i> Job No:</strong>
                                                                        <span>${response.computerno}</span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-dollar" aria-hidden="true"></i> Buying Rate:</strong>
                                                                        <span>${response.fare_rate}</span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-leaf"></i> Sender Name:</strong>
                                                                        <span>${response.sendername}</span>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <strong class="custom-icon-color"><i class="fa fa-cube"></i> Receiver Name:</strong>
                                                                        <span>${response.receivername}</span>
                                                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xamp_7.2.5\htdocs\projects\software2\sms\resources\views/bills/add.blade.php ENDPATH**/ ?>