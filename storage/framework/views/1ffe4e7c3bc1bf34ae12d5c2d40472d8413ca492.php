  <!-- BEGIN: Top Bar -->
      ...
      <div class="top-bar">
         ...
         <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right breadcrumb__icon"><polyline points="9 18 15 12 9 6"></polyline></svg> <a href="" class="breadcrumb--active">Dashboard</a> </div>
         ...
         <div class="intro-x relative mr-3 sm:mr-6">
            ...
            <div class="search-result">
               ...
               <div class="search-result__content">
                  ...
                  <!--      <div class="ml-3"><?php if(auth()->guard()->check()): ?> <?php echo e(Auth::user()->name); ?> <?php endif; ?></div>-->
         ...
         <div class="intro-x dropdown w-8 h-8">
            ...
            <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false">
               ...
               <img alt="Nowshera Tailwind HTML Admin Template" src="https://laraii.com/Software/dist/images/profile-6.jpg">
            ...
            <div class="dropdown-menu w-56">
               ...
               <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                  ...
                  <div class="p-4 border-b border-theme-27 dark:border-dark-3">
                     ...
                     <div class="font-medium"><?php if(auth()->guard()->check()): ?> <?php echo e(Auth::user()->name); ?> <?php endif; ?></div>
                  ...
                  <div class="p-2 border-t border-theme-27 dark:border-dark-3">
                     ...
                     <a href="<?php echo e(url('logout')); ?>" class="flex items-center block p-2 transition duration-300 ease-in-out rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
       ...
       <!-- End : Top Bar -->
<?php /**PATH H:\xamp_7.2.5\htdocs\projects\software2\sms\resources\views/includes/top-bar.blade.php ENDPATH**/ ?>