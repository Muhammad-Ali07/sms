  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Selected Broker Information</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <table id="datatable" class="table table-responsive table-condensed table-bordered">
              ...
              <tbody>
                <?php $balance = 0; ?>
								@foreach($broker_ledger_record as $row)
                <tr>
                  <td>{{$row->bk_id}}</td>
                  <td>
                    <?php
        							if($row->bk_credit == '' || $row->bk_credit == NULL){
        								$date_format = date('d-m-Y',strtotime($row->bk_date));
        							}else{
        								$date_format = date('M-Y',strtotime($row->bk_date));
        							}
        							echo $date_format;
        						?>
                  </td>
                  <td>{{$row->bk_desc}}</td>
                  <td>{{ trim(str_replace(['[', ']', '"'], '', $row->bk_reference)) }}</td>
                  <td><?php echo $debit = $row->bk_debit; ?></td>
                  <td><?php echo $credit = $row->bk_credit; ?></td>
                  <td>
        						<?php
                ...
                <form name="form2" method="post" action='{{url('getCustomerWiseLedgerReport')}}'>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                      <input type="date" id="datepicker" name="from" value="" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                    ...
                    <meta name="csrf-token" content="{{csrf_token()}}">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                      <input type="date" id="datepicker1" name="to" value="" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div class="clearfix"></div>
