        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_panel">
            ...
            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <form method="post" action='{{url('getBrokerLedgerRecord')}}'>

                <input type="hidden" value="{{csrf_token()}}" name="_token" />

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">

                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Broker Name</span>
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                      ...
                      <select name="broker_id" id="broker_id" class="form-control col-md-7 col-xs-12">

                        <option value="-1">Please select a broker</option>

                        @foreach($broker_record as $rec)

                        <option value="{{$rec->broker_id}}">{{$rec->broker_name}}</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <input type="submit" id="view" name="insertdata" class="btn btn-success" value="View Broker Info">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_title">
            ...
            <h2>Generate Date Wise Ledger Report of Broker</h2>
          ...
          <div class="x_content">
            ...
            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <form name="form2" method="post" action='{{url('getBrokerLedgerReport')}}'>

                <input type="hidden" value="{{csrf_token()}}" name="_token" />

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">

                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Select a broker
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <select name="id" id="id" class="form-control col-md-7 col-xs-12">
