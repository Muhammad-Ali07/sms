                ...
                <div class="portlet-body">
                    <div class="row ">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <h2>Select</h2>
                            <form >
                                <div class="form-body alert-block alert-info fade in">
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="form-group">
                                                ...
                                                {{-- <div class="input-group ">
                                                    ...
                                                    {!!  Form::select('employeeID', $employeeslist,$employee->employeeID,['class' => 'form-control input-large','data-placeholder'=>'Select Employee...','onchange'=>'redirect_to()','id'=>'changeEmployee'])  !!}
                                                </div> --}}
                                                <div class="input-group">
                                                    <select name="employeeID" id="changeEmployee" class="form-control input-large" data-placeholder="Select Employee..." onchange="redirect_to()">
                                                        @foreach($employeeslist as $key => $value)
                                                            <option value="{{ $key }}" {{ $employee->employeeID == $key ? 'selected' : '' }}>
                                                                {{ $value }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control input-large monthSelect"
