            ...
            <div class="portlet box purple-wisteria">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="employee_type">
                                    ...
                                    <option value="contract" @if($employee->employee_type=='contract') selected @endif>Contract</option>                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Emergency Phone</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                                <label class="col-md-3 control-label">CNIC Number</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="cnic" placeholder="Enter CNIC Number"
                                        value="{{$employee->cnic}}">
                                </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                value="{{$employee->amount_due}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Previous Balance</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="previous_balance"
                                    placeholder="Previous Balance"
                                    value="{{$employee->previous_balance}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="reference_number"
                                    ...
                                    value="{{$employee->reference_number}}">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="row ">
            <div class="col-md-12 col-sm-12">
                <div class="portlet box purple-wisteria">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-calendar"></i>Employee Financial Details
                        </div>
                        <div class="actions">
                            <button onclick="UpdateDetails('{!! $employee->employeeID !!}','finance')"
                                    class="btn btn-sm btn-default ">
                    ...
                    {{--------------------Employee Financial Record--------------------------------------------}}
                        ...
                        <!-- {!! Form::open(['method' => 'PUT','route'=> ['admin.employees.update', $employee->employeeID],'class'   =>  'form-horizontal','id'  =>  'employeefinances','files'=>true]) !!} -->
                        {!! Form::open(['method' => 'PUT','class'   =>  'form-horizontal','id'  =>  'employeefinances']) !!}
                        <input type="hidden" name="updateType" class="form-control" value="finance">
                        <div class="form-body">
                            <div class="form-group">
                            ...
                            <h2><strong>Advance Salary</strong></h2>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Amount</label>
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="advance_amount" placeholder="Enter Amount">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Description (Reason)</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" name="advance_description" placeholder="Enter Reason"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Paid Via</label>
                                <div class="col-md-9">
                                    <select class="form-control" name="advance_paid_via">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="loan_amount" placeholder="Enter Loan Amount">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Loan Verified By</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="loan_verified_by" placeholder="Verified By">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Loan Paid By</label>
                                <div class="col-md-9">
                                    <select class="form-control" name="loan_paid_by">
                                        <option value="Bank">Bank</option>
                                        <option value="Petty Cash">Petty Cash</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Loan Conditions</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" name="loan_conditions" placeholder="Enter Loan Conditions"></textarea>
                                </div>
                            </div>
                        </div>    
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['resume']))
                                            <a href="{{ $documents['resume'] }}"
                                               target="_blank" class="btn btn-sm purple">View Resume</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['offerLetter']))
                                            <a href="{{ $documents['offerLetter'] }}"
                                               target="_blank" class="btn btn-sm purple">Offer Letter</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['joiningLetter']))
                                            <a href="{{ $documents['joiningLetter'] }}"
                                               target="_blank" class="btn btn-sm purple">View Joining Letter</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['contract']))
                                            <a href="{{ $documents['contract'] }}"
                                               target="_blank" class="btn btn-sm purple">View Contract</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['IDProof']))
                                            <a href="{{ $documents['IDProof'] }}"
                                               target="_blank" class="btn btn-sm purple">View ID Proof</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
