    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <!-- END: Top Bar -->
                ...
                <form method="post" id="pnl_report_form" action="{{ route('pnl_report') }}">
                    @csrf
                    <input name="report_name" type="hidden" value="Pnl Report">
                    <div class="grid">
                            ...
                            <div class="intro-y col-span-12 lg:col-span-12">
                                ...
                                <div class="intro-y box">
                                    <div id="input" class="p-5">
                                        <div class="preview">
                                            <div class="mt-2">
                                                <label class="form-label col-md-4 col-sm-4 col-xs-12">Select period :</label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    ...
                                                    <label><input type="radio" name="period" value="manual"> Manual</label>
                                                </div>
                                           </div>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                   ...
                                                   <input type="date" id="from_date" name="from" class="form-control col-md-7 col-xs-12" />
                                          ...
                                          <div class="mt-2">
                                                 <label class="form-label col-md-4 col-sm-4 col-xs-12" for="first-name">To Date :
                                                  ...
                                                  <div class="col-md-8 col-sm-8 col-xs-12">
                                                   <input type="date" id="to_date" name="to" class="form-control col-md-7 col-xs-12" />
                                                </div>
                                          </div>
                                          <script>
