        ...
        <div class="content">
            ...
            <div class="top-bar">
                ...
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i
                        ...
                        class="breadcrumb--active">PNL Report</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Search -->
            ...
            <!-- END: Top Bar -->
                ...
                <form method="post" id="cdo_report_form" action="{{ route('cdo_report') }}">
                    @csrf
                    <input name="report_name" type="hidden" value="CDO Report">
                    <div class="grid">
                                    ...
                                    <div id="input" class="p-5">
                                        <div class="preview">
                                            <div class="mt-2">
                                                ...
                                                <label class="form-label col-md-4 col-sm-4 col-xs-12">Customer :</label>

                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <select class="form-select col-md-7 col-xs-12" aria-label="Default select example" name="customer_id" id="customerSelect">
                                                        <option selected>Select a customer</option>
                                                        @foreach($data['customers'] as $cst)
                                                            <option value="{{$cst->id}}" data-code="{{$cst->name}}">{{$cst->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="preview">
                                            <div class="mt-2">
                                                ...
                                                <label class="form-label col-md-4 col-sm-4 col-xs-12">CDO# :</label>

                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <select class="form-select col-md-7 col-xs-12" aria-label="Default select example" name="cdo_id" id="cdo">
                                                        <option value="" selected>Select a cdo</option>
                                                        @foreach($data['initializations'] as $ini)
                                                            <option value="{{$ini->id}}" data-code="{{$ini->csm_no}}">{{$ini->csm_no}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                   ...
                                                   <input type="date" required class="form-control col-md-7 col-xs-12" id="from_date" name="from" value="{{date('Y-m-d')}}">
                                          ...
                                          <div class="mt-2">
                                                 <label class="form-label col-md-4 col-sm-4 col-xs-12" for="first-name">To Date :
                                                  ...
                                                  <div class="col-md-8 col-sm-8 col-xs-12">
                                                   <input type="date" id="to_date" name="to" class="form-control col-md-7 col-xs-12" value="{{date('Y-m-d')}}" />
                                                </div>
                                          </div>
                                          <script>
                                            $(document).ready(function() {
                                                ...
                                                $('input[name="period"]').change(function() {
                                                    if ($(this).val() === 'manual') {
                                                        // Enable the date fields if 'Manual' is selected
                                                        $('#from_date, #to_date').prop('disabled', false);
                                                    } else {
                                                        // Disable the date fields if any other option is selected
