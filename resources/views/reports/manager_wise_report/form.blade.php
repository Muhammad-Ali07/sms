    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <!-- END: Top Bar -->
                ...
                <form method="post" id="manager_wise_report_form" action="{{ route('manager_wise_report') }}">
                    @csrf
                    <input name="report_name" type="hidden" value="Manager Wise Report">
                    <div class="grid">
                        <div class="intro-y flex items-center mt-12">
                            <h2 class="text-lg font-medium mr-auto">
                                Manager wise report form
                            </h2>
                        </div>
                                    ...
                                    <div id="input" class="p-5">
                                        <div class="preview">
                                            <div class="mt-2">
                                                ...
                                                <label class="form-label col-md-4 col-sm-4 col-xs-12">Select Manager :
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                  ...
                                                  <select class="form-control col-md-7 col-xs-12" id="manager" name="manager_id">
