    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <!-- END: Top Bar -->
                ...
                <form method="post" id="all_customer_pnl_report_form" action="{{ route('customer_pnl_report') }}">
                    @csrf
                    <input name="report_name" type="hidden" value="Customer Base Pnl Report">
                    <div class="grid">
                        <div class="intro-y flex items-center mt-12">
                            <h2 class="text-lg font-medium mr-auto">
                                Customer Base PNL report form
                            </h2>
                        </div>
