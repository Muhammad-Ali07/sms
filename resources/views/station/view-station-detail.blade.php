 ...
 <div class="flex">
       @include('includes.side-nav')
         <!-- BEGIN: Content -->
            ...
            <form method="post" action="{{route('add-station-process')}}">
               @csrf
            <div class="grid">
                           ...
                           <div class="preview">
                               <div class="grid grid-cols-12 gap-2">
                                 <div class="col-span-6">
                                    ...
                                    <input id="regular-form-2" value="{{$stataion->station_id}}"   readonly type="text" class="form-control" placeholder="ID" name="station_id">
                                 </div>
                              </div>
                               <div class="mt-2 c_name">
                                 <label for="regular-form-2" class="form-label">Station Name</label>
                                 <input id="regular-form-2" type="text" value="{{isset($stataion->name) ? $stataion->name : ''}}" readonly  class="form-control" placeholder="Enter Name in English" name="name">

                                 <input id="txtBox" name="name_urdu" type="text" value="{{isset($stataion->name_urdu) ? $stataion->name_urdu : ''}}" readonly    class="form-control UrduFont" placeholder="اردو میں نام درج  کریں" >
                              </div>
                              <div class="grid grid-cols-12 gap-2">
                              <div class="col-span-6 mt-2">
                                 <label for="txtBox" class="form-label">Agent Name</label>
                                  <input id="regular-form-5" type="text" class="form-control" value="{{isset($stataion->agent_name) ? $stataion->agent_name : '' }}" readonly   placeholder="Enter Agent Name" name="agent_name">
                              </div>
                              <div class="col-span-6 mt-2">

                                 <label for="txtBox" class="form-label">Commission</label>
                                  <input id="regular-form-5" type="text"  class="form-control" value="{{isset($stataion->commission) ? $stataion->commission : '' }}" readonly  placeholder="Type in percentage" name="commission">
                              </div>
                              </div>
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative phoneDivbar">
                                 <div class="col-span-12">
                                    <div class="mt-2">
                                       ...
                                       @if(isset($stataionPhone))
                                           @foreach($stataionPhone as $phone)
                                           <input id="regular-form-5" type="text" class="form-control"  value="{{$phone->phone}}" readonly>
                                            @endforeach
                                        @endif
                                    </div>
                              ...
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative-textarea phoneDivAddress_stat">
                                 <div class="col-span-12">
                                    <div class="mt-2">
                                       ...
                                       @if(isset($stataionAddress))
                                           @foreach($stataionAddress as $Address)
                                           <input id="regular-form-5" type="text" class="form-control"  value="{{$Address->address}}" readonly>
                                            @endforeach
                                        @endif
                                    </div>
                              ...
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Other Charges Details</label>
                                 @if(isset($stataioncharges))
                                     @foreach($stataioncharges as $charges)
                                           <input id="regular-form-5" type="text" class="form-control"  value="{{$charges->charges}}" readonly>
                                            @endforeach
                                @endif
                              </div>
                              <div class="col-span-3">
                                ...
                                @if(isset($stataioncharges))
                                 @foreach($stataioncharges as $chargesAmount)
                                       <input id="regular-form-5" type="text" class="form-control"  value="{{$chargesAmount->amount}}" readonly>
                                        @endforeach
                                @endif
                              </div>
