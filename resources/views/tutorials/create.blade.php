...
@section('main-content')
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <!-- END: Top Bar -->
            @if (empty($select))
                <form method="post" id="tutorial_form" action="{{ route('videos.store') }}" enctype="multipart/form-data">
                @else
                    {{-- <form method="post" id="tutorial_update_form" action="{{ route('videos.update', ['id' => $select->id]) }}" enctype="multipart/form-data"> --}}
            ...
            @endif
                ...
                @endphp
                @if (!Request::is('*shippingLine-edit*'))
                    <div class="grid">
                   <div class="intro-y flex items-center mt-12">
                      <h2 class="text-lg font-medium mr-auto">
                      </h2>
                            ...
                            <div id="input">
                                <div class="preview">
                                   ...
                                   <tbody>
                                          ...
                                          <tr>
                                                <td>{{$tut->module_name}}</td>
                                                <td class="video-cell" data-video="{{ asset($tut->video_path) }}" style="cursor: pointer;">Watch Video</td>
                                                <td>
                                                    {{-- <a href="{{route('shippingLine.edit',[$item->id])}}">Edit</a>
                                                    <a class="deleteShippingLine" href="javascript:void(0)" data-url="{{route('shippingLine.delete',[$item->id])}}" data-name="{{$item->name}}">Delete</a> --}}
                                                </td>
                                             </td>
                                          </tr>
                                          @endforeach
