...
{{--
        ...
        <ul class="" style="{{ Request::is('add-bilty','view-bilty','view-walkin-builty') ? 'display:block;' : 'display:none;' }}">
            ...
            @if (Auth::user()->role_id != 1 && Auth::user()->role_id != 2)
                <li>
                    ...
                    <a href="{{ route('view-walkin-builty') }}" class="side-menu class="side-menu {{ Request::is('view-walkin-builty') ? 'sub-menu-active' : '' }}">
    ...
    <li>
        ...
        <ul class="" style="{{ Request::is('ledger','customer-ledger','salary_ledger','emp_ledger','bank_ledger') ? 'display:block;' : 'display:none;' }}">
    ...
    @if (!empty(Auth::user()) && Auth::user()->id == 1)
        ...
        @if (session('company')[0]->id == 1)
            ...
            <li class="">
                ...
                <a href="javascript:;" class="side-menu {{ Request::is('manager-wise-report-page', 'customer-wise-report-page', 'station-wise-report-page', 'broker-wise-report-page', 'pnl-report-page') ? 'side-menu--active' : '' }}">
                ...
                <ul class="" style="{{ Request::is('manager-wise-report-page', 'customer-wise-report-page', 'station-wise-report-page', 'broker-wise-report-page', 'pnl-report-page') ? 'display:block;' : 'display:none;' }}">
