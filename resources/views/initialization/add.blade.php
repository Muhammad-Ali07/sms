                        ...
                        <div class="intro-y box">
                            ...
                            <div id="input" class="p-5">
                                ...
                                <div class="preview">
                                    ...
                                    <form id="myForm" method="post" action="{{ route('save-initialization') }}"
                                            ...
                                            <div class="tab-pane fade show active" id="main" role="tabpanel"
                                                ...
                                                <div class="classic open_classic">
                                                    ...
                                                    <div class="grid grid-cols-12 gap-2 mt-2 mb-2">
                                                        ...
                                                        <div id="walkin_customer_div"
                                                            class="walkin_customer_div col-span-4">

                                                            <label for="regular-form-22" class="form-label">CDO No#</label>

                                                            <input id="regular-form-22" type="text" readonly
                                                                class="form-control" value="{{ $initialization_no }}"
                                                                name="initialization_code">

                                                        </div>
                                                        <div class="col-span-4">
                                                            <label for="regular-form-2" class="form-label">DO Date</label>
                                                            <input type="date" class="form-control" id="do_date"
                                                        ...
                                                        <div class="col-span-4">
                                                            <label for="regular-form-4" class="form-label">Consignee
                                                                Name</label>
                                                            <select id="consignee_id" class="form-select"
                                                                aria-label="Default select example" name="consignee_id">
                                                                <option value="">--select--</option>
                                                                @foreach ($customers as $cst)
                                                                    <option value="{{ $cst->id }}">{{ $cst->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-span-4">
                                                            ...
                                                            <input id="bl_no" type="text" class="form-control"
                                                                placeholder="BL#" name="bl_no">
                                                    ...
                                                    <div class="show_fields">
                                                        <div class="grid grid-cols-12 gap-2 mt-2" id="bl_lc_container_div">
                                                            <div class="col-span-4">
                                                                ...
                                                                <label for="regular-form-2" class="form-label">Expiry
                                                                    Date</label>

                                                                <input id="regular-form-2" type="date"
                                                                    class="form-control" id="date" name="expiry_date"
                                                                    value="{{ date('Y-m-d') }}">
                                                    ...
                                                    <div class="show_fields mt-2">
                                                        <div class="grid grid-cols-12 gap-2 mt-2">
                                                            ...
                                                            <div class="col-span-4">
                                                                <label for="regular-form-1" class="form-label">Deposit
                                                                    By</label>
                                                                <select id="payment_by" class="form-select"
                                                                    aria-label="Default select example" name="deposit_by">
                                                                    <option value="">--select--</option>
                                                            ...
                                                            <div id="customerDropdownContainer" class="col-span-4"
                                                                style="display: none;">
                                                            ...
                                                            <div id="depositorDropdownContainer" class="col-span-4"
                                                                style="display: none;">
                                                                <label for="depositor_id" class="form-label">Select
                                                                    Depositor</label>
                                                                <select id="depositor_id" name="depositor_id"
                                                                    class="form-select">
                                                                    ...
                                                                    @foreach ($depositors as $depositor)
                                                                        <option value="{{ $depositor->id }}">
                                                                            {{ $depositor->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="col-span-4">

                                                                <label for="regular-form-2" class="form-label">Payment
                                                                    Date</label>
                                                            ...
                                                            <div class="col-span-4">
                                                                <label for="regular-form-4" class="form-label">Deposit
                                                                    Amount</label>
                                                            ...
                                                            <div class="col-span-4">
                                                                <label for="regular-form-4" class="form-label">Service
                                                                    Charges</label>
                                                                <input id="supplier_charges" type="text"
                                                                    class="form-control" placeholder="Supplier Charges"
                                                                    name="supplier_charges">
                                                            </div>
                                                            <div class="col-span-4">
                                                                <label for="regular-form-4"
...
@section('script')
    ...
    <script>
        ...
        $(function() {
            ...
            $('body').on('click', '.pagination a', function(e) {
                ...
                $('#load').append(
                    '<img style="position: absolute; left: 50%; top: 40%; z-index: 100000;" src="{{ url('/images/loading.gif') }}" />'
                    );
        ...
        $(document).ready(function() {
            ...
            if (returnvalue != 0) {
                ...
                $(".logo_div").html(
                    '<label for="regular-form-1" class="form-label">Selected Company</label><img width="100" height="100" src="' +
                    logo + '" />');
        ...
        $(document).on('change', '.to', function() {
            ...
            if ($('.package_id').val != '' && $('.from').val != '' && $('.to').val != '') {
                ...
                $.ajax({
                    ...
                    data: {
                        station_from: $(".from").val(),
                        station_to: $(".to").val(),
                        sender_id: $(".customerbilled").val(),
    ...
    <script>
        $(document).ready(function() {
            ...
            var y = 1;
            var x = 1;
            var wrapper = $(".GoodCalculation");
            var add_button = $(".AddMoreGoodCalculation");
            var x = 1;
            $(add_button).click(function(e) {
                ...
                e.preventDefault();
                $(wrapper).append('<div class="remove_here' + x +
                    ' grid grid-cols-12 gap-2 mt-2 positon-relative "><div class=" col-span-2" ><label for="regular-form-1" class="form-label">Packages</label>   <select name="package_id[]" id="regular-form-1" data-id="' +
                    y + '" class="changepackage package_id' + y +
                    ' form-select sm:mr-2" aria-label="Default select example"></select></div>  <div class="col-span-2"> <label for="regular-form-1" class="form-label">Desc</label><input  type="text" placeholder="Enter description" class="desc' +
                    y +
                    ' form-control"  name="desc[]"></div><div class="col-span-2"><label for="regular-form-1" class="form-label">QTY</label><input  type="text" placeholder="QTY" class="form-control"  name="quantity[]"></div><div class="col-span-2 lcl_amount_status" data-id="' +
                    x +
                    '" style="display:none"><label for="regular-form-1" class="form-label">Amount</label><input  type="text" placeholder="Amount" class="form-control"  name="Amount[]"></div><div class="hidetopay col-span-2" style="display: none"><label for="regular-form-1" class="form-label">Supplier</label><select name="supplier_type" data-id="' +
                    x + '" class="drop suplier_feild' + x +
                    ' form-select sm:mr-2" aria-label="Default select example"><option value="">Select option</option><option value="per_carton">Per Carton</option><option value="lump_sum">Lump Sum</option></select></div><div class="lumbsum' +
                    x +
                    ' col-span-2" style="display:none"><label for="regular-form-1" class="form-label">Lump sum Amount</label><input  type="text" placeholder="Lumb Sum Amount" class="form-control"  name="lumpsum[]"></div><div class="perCarton' +
                    x +
                    ' col-span-2" style="display:none"><label for="regular-form-1" class="form-label">Per Carton Rate </label><input  type="text" placeholder="Per Carton Amount" class="form-control"  name="carton[]"></div><div class="col-span-2"><label for="regular-form-1" class="form-label">Weight</label><input  type="text" placeholder="Enter Weight" class="form-control" name="weight"> </div><div class="col-span-1 charges_div"><label for="regular-form-1" class="form-label">Charges</label><select name="charges[]" data-id="0" class="charges form-select sm:mr-2" aria-label="Default select example"><option value="">Select option</option><option value="per_quantity">Per Quantity</option><option value="per_weight">Per Weight</option></select></div><div class="col-span-1"> <button type="button" class="remove_builty btn btn-danger" data-id=' +
                    x + ' >Remove</button> </div></div></div>');
                x++;
