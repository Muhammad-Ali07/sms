                                   ...
                                   <div class="classic open_classic">
                                        ...
                                        <div class="col-span-4">
                                            ...
                                            <select id="job_no" class="form-select sm:mr-2"
                                                ...
                                                @foreach($builties as $b)
                                                    <option value="{{$b->computerno}}" 
                                                    {{ isset($initialization) && $initialization->job_no == $b->computerno ? 'selected' : '' }}
                                                    >{{$b->computerno}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                          ...
                                          <div class="col-span-4">
                                               ...
                                               <label for="regular-form-4" class="form-label">Container No.</label>
        
                                               <input  id="container_no" type="text" class="form-control" value="{{isset($initialization->container_no) ? $initialization->container_no : ''}}" placeholder="Container No#" name="container_no">
        
                                          </div>
                                           <div class="col-span-4">
                                                <label for="regular-form-5" class="form-label">No. of Containers</label>

                                                <select id="regular-form-1" class="form-select sm:mr-2"
                                                    aria-label="Default select example" name="no_of_containers">
                                                    @foreach ($containerOptions as $option)
                                                        <option value="{{ $option }}" 
                                                            {{ isset($initialization) && $initialization->no_of_containers == $option ? 'selected' : '' }}>
                                                            {{ $option }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                      ...
                                      <div class="show_fields">
                                            ...
                                            <div class="grid grid-cols-12 gap-2 mt-2" id="bl_lc_container_div">
                                                ...
                                                <!--   <input  id="regular-form-2" type="date" class="form-control" id="date" value="{{$initialization->expiry_date}}" name="expiry_date" value="{{date('Y-m-d')}}">-->
