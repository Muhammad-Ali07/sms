...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav')
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">SelfCompany</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
            ...
            @if(empty($edit))
            <form method="post" action="{{route('add-self-company')}}"   enctype= "multipart/form-data">
            @else
            <form method="post" action="{{route('save-edit-self-company')}}"   enctype= "multipart/form-data">
            @endif
                           ...
                           <div class="preview">
                               <div class="grid grid-cols-12 gap-2">
                                 <div class="col-span-6">
                                    ...
                                    <input required id="regular-form-2" type="text" value="@if(!empty($edit)) {{$edit->name}}  @endif" class="form-control txtOnly"  placeholder="Name" name="name">
                                    <input id="regular-form-2" type="hidden" value="@if(!empty($edit)) {{$edit->id}}  @endif"  name="id">
                                 </div>
                                 <div class="col-span-6">
                                    <label for="regular-form-1" class="form-label">Logo</label>
                                    @if(!empty($edit))  <img width="200" height="200" src="{{asset('selfcompany_image/'.$edit->logo )}}">
                                     @else
                                    <input id="regular-form-2" type="file" class="form-control" placeholder="Name" name="logo">
                                @endif
                                 </div>
                              </div>
                              <div class="grid grid-cols-12 gap-2">
                              <div class="col-span-6 mt-2">
                                ...
                                <input id="valid" type="number" @if(!empty($edit))  value="{{$edit->phone}}"  @endif class="form-control" placeholder="Enter Phone" name="phones">
                              </div>
                              <div class="col-span-6 mt-2">
                                 <label for="regular-form-6" class="form-label">Address</label>
                                       <input type="text" id="regular-form-6" value="@if(!empty($edit)) {{$edit->address}}  @endif" class="form-control" placeholder="Enter Address"  name="address">
                              </div>
                              <div class="col-span-6 mt-2">
                                <label for="regular-form-6" class="form-label">NTN</label>
                                      <input type="text" id="regular-form-6" value="@if(!empty($edit)) {{$edit->ntn}}  @endif" class="form-control" placeholder="Enter NTN"  name="ntn">
                             </div>
                              </div>
                             <!-- <div class="grid grid-cols-12 gap-2 mt-2 positon-relative Attach">
                              <div class="col-span-8">
                                    <label for="regular-form-1" class="form-label">Company Attachment</label>
                                    <input id="regular-form-2" type="file" class="form-control" placeholder="Name"  accept=".doc, .docx, .pdf" name="files">
                                 </div>
                              <div class="col-span-4">
                                <button class="btn btn-primary mt-5 AddMoreAttach">Add More</button>
                              </div>
                           </div> -->
                            ...
                            @endif
                              ...
                              <div id="input" class="p-5">
                           <div class="preview">
                              <table id="selCompanyTable" class="display nowrap" style="width:100%">
                                 <thead>
                                    <tr>
                                       <th>Name</th>
                                       <th>Phone </th>
                                 ...
                                 <tbody>
                                             ...
                                             @foreach($selfcompany as $details)
                                       <tr>
                                          <td> {{$details->name}} </td>
                                          <td> {{$details->phone}} </td>
                                          ...
                                          <td>
                                                ...
                                                @if($user_meta->setup == 1)
                                                    @if($user_meta->edition == 1)
                                                       <a href="edit-self-company/{{$details->id}}" > Edit</a>
                                                    @endif
                                                @endif
