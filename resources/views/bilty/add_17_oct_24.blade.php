                                   ...
                                   <div class="classic open_classic">
                                      ...
                                      <div class="grid grid-cols-12 gap-2 mt-2 mb-2">
                                         ...
                                         <div class="show_fields col-span-4">
                                            ...
                                            <input  type="text" class="job_id form-control" readonly id="job_no" name="job_id" value="">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                console.log(jobInquiryData);
                    ...
                    const dbDate = "2024-10-05";  // Example date from the database (replace this with `jobInquiryData.date`)
