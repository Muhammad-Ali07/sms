...
<div class="flex">
                     ...
                     <div class="preview">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item" role="presentation">
                            <button class="nav-link active btn btn-primary" id="home-tab" data-toggle="tab" data-target="#main" type="button" role="tab" aria-controls="home" aria-selected="true">Home</button>
                          </li>
                          <li class="nav-item" role="presentation">
                            <button class="nav-link btn btn-primary" id="profile-tab" data-toggle="tab" data-target="#buying" type="button" role="tab" aria-controls="profile" aria-selected="false">Profile</button>
                          </li>
                        </ul>
                        <form id="myForm" method="post" action="{{route('add-bilty-process')}}" onkeydown="return event.key != 'Enter';">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="home-tab">
                                   <div class="classic open_classic">
                                         ...
                                         <div class="flex flex-col sm:flex-row mt-2">
                                            ...
                                            <div class="grid grid-cols-12 gap-2 mt-2 mb-2">
                                               ...
                                               <div class="col-span-6" style='margin:0px 0px 0px 30px;padding '>
                                                  ...
                                                  <input  id="radio-switch-1" class="form-check-input" type="radio" name="customerTtype" value="Walkin">
                                      ...
                                      <div class="show_fields">
                                         ...
                                         <div class="grid grid-cols-12 gap-2">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <select  id="regular-form-1" class="form-select sm:mr-2 language" aria-label="Default select language"  name="deliverymode">
                                      ...
                                      <div class="show_fields">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2">
                                            ...
                                            <div class="flex items-center">
                                                  <input type="radio" id="bl-number" name="number-type" class="form-radio">
                                                  <label for="bl-number" class="ml-4">B.L Number</label>
                                            </div>
                                            <div class="flex items-center">
                                                  <input type="radio" id="container-number" name="number-type" class="form-radio">
                                                  <label for="container-number" class="ml-4">Container Number</label>
                                            </div>
                                            <div class="flex items-center">
                                                  <input type="radio" id="lc-number" name="number-type" class="form-radio">
                                      ...
                                      <div class="show_fields mt-2 col-span-6">
                                         ...
                                         <label class="form-label">Goods Calculation</label> <br><br>
                                         <input  id="radio-switch" class="builty_type form-check-input" type="radio" name="builty_type" value="hide">
        
                                         <label class="form-check-label"  style="font-size:18px">hidden</label>
        
                                         <input  id="radio-switch-41" class="builty_type form-check-input" type="radio" name="builty_type" value="lcl">
        
                                         <label class="form-check-label" for="radio-switch-41" style="font-size:18px">Charges</label>
                                      ...
                                      <div class="fcl_div">
                                           ...
                                           <div class="grid grid-cols-12 gap-2 mt-2 positon-relative">
                                            ...
                                            <div class="hidetopay col-span-2" style="display:none">
                                               ...
                                               <label for="regular-form-1" class="form-label">Goods Calculation</label>
                                         ...
                                         <div  id="lcl_topay" style="display: none;POSITION: relative;">
                                            ...
                                            <div class="grid grid-cols-12 gap-2 mt-2 positon-relative">
                                               ...
                                               <div class="col-span-2">
                                                  ...
                                                  <label for="regular-form-1" class="form-label">TT</label>
        
                                                  <input  type="text" onchange="calc()" value="" id="freight" placeholder="Enter TT rate" class="form-control"  name="freight">
                                               ...
                                               <div class="col-span-2">
                                                  ...
                                                  <label for="regular-form-1" class="form-label">Local Charges</label>
                                               ...
                                               <div class="col-span-2">
                                                  ...
                                                  <label for="regular-form-1" class="form-label">Lifter Crane Charges</label>
        
                                                  <input  type="text" onchange="calc()" value="" id="other" placeholder="Enter lift crane charges" class="form-control"  name="other">
                                ...
                                <div class="tab-pane fade" id="buying" role="tabpanel" aria-labelledby="profile-tab">
                                  <div class="show_fields mt-4 col-span-6">
                                        ...
                                        <div class="show_fields">
                                            <div class="grid grid-cols-12 gap-2 mt-2">
                                                <div class="col-span-6">
                                                    ...
                                                    <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Fare Rate" name="fare_rate">
                                                </div>
                                                <div class="col-span-4">
                                                    <label for="regular-form-1" class="form-label">Buying Party</label>
                                                    <select id="regular-form-1" class="form-select" aria-label="Default select example" name="deliverymode">
                                    ...
                                    <div class="show_fields mt-2 col-span-6">
    <label class="form-label">Expense Purchase</label> <br><br>
    <div class="show_fields">
        <div class="grid grid-cols-12 gap-2 mt-2">
            <div class="col-span-6">
                <label for="regular-form-4" class="form-label">Name</label>
                <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Buyer Name" name="buyer_name">
            </div>
            <div class="col-span-6">
                <label for="regular-form-4" class="form-label">Description</label>
                <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Buyer Description" name="buyer_description">
            </div>
            <div class="col-span-6">
                <label for="regular-form-4" class="form-label">Amount</label>
                <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Buying Amount" name="buying_rate">
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <div class="show_fields mt-4 col-span-6">
                                        <label class="form-label">Expense Selling</label> <br><br>
                                        <div class="show_fields">
                                            <div class="grid grid-cols-12 gap-2 mt-2">
                                                <div class="col-span-6">
                                                    <label for="regular-form-4" class="form-label">Name</label>
                                                    <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Seller Name" name="seller_name">
                                                </div>
                                                <div class="col-span-6">
                                                    <label for="regular-form-4" class="form-label">Description</label>
                                                    <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Seller Description" name="seller_description">
                                                </div>
                                                <div class="col-span-6">
                                                    <label for="regular-form-4" class="form-label">Amount</label>
                                                    <input id="regular-form-4" type="text" class="form-control" placeholder="Enter Selling Amount" name="selling_rate">
                                                </div>
                                            </div>
   ...
   @foreach($builties as $builty)
      <?php
         // Fetch builty items inside the loop
         $itmes = DB::table('now_builtyitems')
                   ->select('now_builtyitems.quantity as quantity', 'now_builtyitems.brand as brand')
                   ->where('builtyid', $builty->bid)
                   ->first();
      ?>
      <tr>
         ...
         <td>{{ $builty->cutomer_type == 'Walkin' ? $builty->sendername : ($builty->name ?? 'Ali') }}</td>
