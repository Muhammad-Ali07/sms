                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#bilties_filter_btn').click(function() {
                                                    ...
                                                    if (fromDate && toDate) {
                                                        $.ajax({
                                                            url: "{{ route('filter-bilties') }}", // Update this to the actual route that handles filtering
                                                            method: "GET",
                                                            data: {
                                            ...
                                            @if(!empty($builties))
                                                @foreach($builties as $b)
                                                    <tr>
                                                        ...
                                                        <td>{{ $b->total_purchase_expense }}</td>
                                                        <td>{{ $b->total_selling_expense }}</td>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#bill_filter_btn').click(function() {
                                                    ...
                                                    if (fromDate && toDate) {
                                                        $.ajax({
                                                            url: "{{ route('filter-bill') }}", // Update this to the actual route that handles filtering
                                                            method: "GET",
                                                            data: {
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#rfq_filter_btn').click(function() {
                                                    ...
                                                    if (fromDate && toDate) {
                                                        $.ajax({
                                                            url: "{{ route('filter-rfq') }}", // Update this to the actual route that handles filtering
                                                            method: "GET",
                                                            data: {
                                        ...
                                        <tbody>
                                            @if(!empty($job_inquiries))
                                                @foreach($job_inquiries as $ji)
                                                    <tr>
                                                        <td>{{ $ji->customer_name }}</td>
                                                        <td>{{ $ji->manager_name }}</td>
                                                        <td>{{ $ji->selling_rate }}</td>
                                                        <td>{{ $ji->status }}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
