...
@section('main-content')
    ...
    <div class="flex">
        ...
        @endphp
            ...
            @if (empty($select))
                <form method="post" id="shipping_line_form" action="{{ route('shippingLine.store') }}">
                @else
                    <form method="post" id="pickup_point_update" action="{{ route('shippingLine.update', ['id' => $select->id]) }}">
                                ...
                                <div id="input" class="p-5">
                                    <div class="preview">
                                        <div class="mt-2 c_name">
                                            <label for="regular-form-2" class="form-label">Shipping Line</label>
