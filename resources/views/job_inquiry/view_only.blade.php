                                   ...
                                   <div class="classic open_classic">
                                      ...
                                      <div class="grid grid-cols-12 gap-2 mt-2 mb-2">
                                         ...
                                         <div id="Billed_customer_div" class="Billed_customer_div col-span-4" style='display:none'>
                                            ...
                                            <select  id="regular-form-1" disabled class="customerbilled form-select sm:mr-2" aria-label="Default select example" name="customerbilled">
                                         ...
                                         <div id="walkin_customer_div" class="walkin_customer_div col-span-4">
                                            ...
                                            <input id="regular-form-22" disabled type="text" value="{{$select->customer}}" class="walkinCustmer form-control" name="customer">
                                         ...
                                         <div class="col-span-4">
                                            ...
                                            @if(isset($select->manager_id))
                                                <select  id="regular-form-1" disabled class="form-select sm:mr-2" aria-label="Default select example" name="manager_id">
                                         ...
                                         <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-2" disabled type="date" readonly required class="form-control" id="date" name="date" value="{{ isset($select->date) ? $select->date : date('Y-m-d') }}">
                                      ...
                                      <div class="show_fields">
                                         ...
                                         <div class="grid grid-cols-12 gap-2">
                                            ...
                                            <div class="billed_builty_type col-span-4" style="display:none">
                                               ...
                                               <select tabindex="-1" disabled required class="changetopay builtyType form-select sm:mr-2" aria-label="Default select example" name="Builtytype">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <select  id="regular-form-1" disabled class="form-select sm:mr-2 language" aria-label="Default select language"  name="language">
                                      ...
                                      <div class="show_fields mt-2">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2 positon-relative senderForm">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled required type="text" class="sender form-control" value="{{$select->sendername}}" placeholder="Enter Sender Name" name="sendername">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled type="text" class="form-control" value="{{$select->senderphone}}" placeholder="Enter Sender Phone" name="senderphone">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled required type="text" class="form-control" value="{{$select->receivername}}" placeholder="Enter Receiver Name"   name="receivername">
                                      ...
                                      <div class="show_fields mt-2">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2 positon-relative receiverForm">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled type="text" value="{{$select->receiverphone}}" class="form-control" placeholder="Enter Receiver Phone" name="receiverphone">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  type="text" disabled placeholder="Weight" class="weight form-control" value="{{$select->weight}}"  name="weight">
                                            ...
                                            <div class="col-span-4" id="supplier_charges_div" >
                                               ...
                                               <input  type="text" disabled placeholder="Enter Number" class="form-control sm:mr-2" value="{{$select->supplier_charges}}" name="supplier_charges">
                                      ...
                                      <div class="show_fields">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2">
                                            ...
                                            <div class="col-span-6">
                                               ...
                                               <select  id="regular-form-1" disabled class="from form-select sm:mr-2" aria-label="Default select example"  name="from">
                                            ...
                                            <div class="col-span-6">
                                               ...
                                               <select id="regular-form-1" disabled class="to form-select sm:mr-2" aria-label="Default select example" name="to">
                                                    @if(!empty($stationsTo))
                                            ...
                                            <div class="grid grid-cols-12 gap-2 mt-2" id="bl_lc_container_div">
                                                <div class="col-span-2">
                                                    <div class="flex items-center">
                                                        <input type="checkbox" id="bl-number" disabled
                                                    ...
                                                    <div class="flex items-center">
                                                        <input type="checkbox" id="container-number" disabled
                                                ...
                                                <div class="col-span-12" id="dynamic-inputs" style="display: flex; flex-wrap: nowrap; overflow-x: auto;">
                                                    @if(!empty($select->container_number))
                                                        <div id="container-number-input" class="input-container col-span-4 mr-4">
                                                            ...
                                                            <input type="text" disabled value="{{$select->container_number}}" placeholder="Container Number" class="form-control" name="container_number">
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if(!empty($select->bl_number))
                                                        <div id="bl-number-input" class="input-container col-span-4 mr-4">
                                                            ...
                                                            <input type="text" disabled placeholder="B.L Number" value="{{$select->bl_number}}" class="form-control" name="bl_number">
                                                        </div>
                                                    @endif
                                                    @if(!empty($select->lc_number))
                                                        <div id="lc-number-input" class="input-container col-span-4 mr-4">
                                                            ...
                                                            <input disabled type="text" placeholder="L.C Number" class="form-control" value="{{$select->lc_number}}" name="lc_number">
                                                        </div>
                                                    @endif
                                                    @if(!empty($select->seal_number))
                                                        <div id="seal-number-input" class="input-container col-span-4 mr-4">
                                                            ...
                                                            <input disabled type="text" placeholder="Seal Number" class="form-control" value="{{$select->seal_number}}" name="seal_number">
                                                        </div>
                                                    @endif
                                                </div>
                                      ...
                                      <div class="show_fields mt-2">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2 positon-relative senderForm">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled type="text" class="Local Vehicle form-control" value="{{$select->local_vehicle_no}}" placeholder="Enter Vehicle Number" name="local_vehicle_no">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled type="text" class="form-control" placeholder="Driver Mobile No" value="{{$select->local_mobile_no}}" name="local_mobile_no">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" disabled type="text" class="form-control" value="{{isset($select->type_of_good) ? $select->type_of_good : ''}}" placeholder="Type of Goods..." name="type_of_goods">
                                      ...
                                      <div class="show_fields mt-2">
                                         <div class="grid grid-cols-12 gap-2 mt-2">
                                            ...
                                            <div class="col-span-4">
                                                ...
                                                <select id="regular-form-1" disabled class="form-select" aria-label="Default select example" name="package_id">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  type="text" disabled placeholder="Enter Note" value="{{$select->note}}" class="form-control sm:mr-2"  name="note">
                                      ...
                                      <div class="show_fields">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2">
                                            ...
                                            <div class="col-span-12">
                                               ...
                                               <input  type="text" disabled placeholder="Enter Delivery Address" value="{{$select->deliveryaddress}}" class="form-control sm:mr-2" name="deliveryaddress">
                                            ...
                                            @foreach($broker_info as $broker)
                                                <div class="expense_fields grid grid-cols-12 gap-2 mt-2">
                                                    <div class="col-span-6">
                                                        ...
                                                        <select id="regular-form-1" disabled class="form-select" aria-label="Default select example" name="broker_id[]">
                                                    ...
                                                    <div class="col-span-6">
                                                        ...
                                                        <input id="buying_rate_1" disabled type="text" class="form-control number-input" value="{{$broker->broker_rate}}" placeholder="Enter Buying Amount" name="broker_rate[]">
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        ...
                                        <div id="expense_selling_fields_wrapper">
                                            <div class="grid grid-cols-12 gap-2 mt-2" id="selling_field_0">
                                                <div class="col-span-6">
                                                    ...
                                                    <input id="selling_rate" disabled type="text" class="form-control number-input" value="{{isset($select->selling_rate) ? $select->selling_rate : ''}}" placeholder="Enter Selling Amount" name="selling_rate">
                                                </div>
                                                <div class="col-span-6">
                                                    <label for="seller_description" class="form-label">Description</label>
                                                    <input id="seller_description" disabled type="text" class="form-control" value="{{$select->selling_description}}" placeholder="Enter Seller Description" name="selling_description">
                                                </div>
