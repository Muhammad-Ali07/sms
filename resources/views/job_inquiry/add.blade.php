               ...
               <div class="intro-y box">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between p-5 border-b border-gray-200 dark:border-dark-5">
                        <div class="row w-full">
                            ...
                            <div class="col-lg-6 d-flex justify-content-end">
                                <p class="float-right"><b>{{$code}}</b></p>
                            </div>
                        </div>
                    </div>
                  ...
                  <div id="input" class="p-5">
                     ...
                     <div class="preview">
                        ...
                        <form id="myForm" method="post" action="{{route('save-job-inquiry')}}" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
                                   ...
                                   <div class="classic open_classic">
                                      ...
                                      <div class="grid grid-cols-12 gap-2 mt-2 mb-2">
                                         ...
                                         <div id="Billed_customer_div" class="Billed_customer_div col-span-4" style='display:none'>
                                            ...
                                            <select  id="regular-form-1" class="customerbilled form-select sm:mr-2" aria-label="Default select example" name="customerbilled">
                                               ...
                                               @foreach($customers as $billedCustomer)
                                         ...
                                         <div class="col-span-4">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-2" type="date" readonly required class="form-control" id="date" name="date" value="{{date('Y-m-d')}}">
                                      ...
                                      <div class="show_fields mt-2">
                                         ...
                                         <div class="grid grid-cols-12 gap-2 mt-2 positon-relative senderForm">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" type="text" class="Local Vehicle form-control" placeholder="Enter Vehicle Number" name="local_vehicle_no">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  id="regular-form-4" type="text" class="form-control" placeholder="Enter Driver Mobile No" name="local_mobile_no">
                                            ...
                                            <div class="col-span-4">
                                               ...
                                               <input  type="text" placeholder="Enter..." class="form-control sm:mr-2"  name="type_of_goods">
                                      ...
                                      <div class="show_fields mt-2">
                                         <div class="grid grid-cols-12 gap-2 mt-2">
                                            ...
                                            <div class="col-span-4">
                                                <label for="regular-form-1" class="form-label">Type of Package</label>
                                        ...
                                        <div id="expense_fields_wrapper">
                                            <div class="expense_fields grid grid-cols-12 gap-2 mt-2">
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <input id="buying_rate_1" type="text" class="form-control number-input" placeholder="Enter Buying Amount" name="broker_rate[]">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="expense_selling_fields_wrapper">
                                            <div class="grid grid-cols-12 gap-2 mt-2" id="selling_field_0">
                                                <div class="col-span-4">
                                                    ...
                                                    <input id="selling_rate" type="text" class="form-control number-input" placeholder="Enter Selling Amount" name="selling_rate">
                                                </div>

                                                <div class="col-span-4">
                                                    <label for="seller_description" class="form-label">Description</label>
                                                    <input id="seller_description" type="text" class="form-control" placeholder="Enter Seller Description" name="selling_description">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
