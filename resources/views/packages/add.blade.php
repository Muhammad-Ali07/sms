...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav')
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Package</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-1"  class="form-label">Package Name</label>
                                    <input type="hidden"  value="@if(!empty($edit)) {{$edit->id}} @endif" name="id">
                                    <input id="regular-form-2"  value="@if(!empty($edit)) {{$edit->packagename}} @endif" required type="text" class="form-control" placeholder="Package Name" name="name">
                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Description</label>
                                    <input type="text" id="regular-form-6" class="form-control" value="@if(!empty($edit)) {{$edit->description}} @endif" placeholder="Enter Address" name="description">
                              </div>
                           ...
                           <div class="preview">
                            ...
                            <!--        <input type="text" name="name_package" id="name_package" placeholder="Search Name" value="{{ request('name_package') }}" class="form-control">-->
                            <!--        <input type="text" name="description_package" id="description" placeholder="Search Description" value="{{ request('description_package') }}" class="form-control">-->
                            <!--    </div>-->
                            <!--    <a href="#" class="btn btn-primary mt-2" onclick="submitSearch()">Search</a>-->
                            <!--</form>-->
                            <table id="packages_table" class="display nowrap" style="width:100%">
                                 <thead>
                                    <tr>
                                       <th>Package Name</th>
                                        <th>Description</th>
                                    ...
                                    @foreach($packages as $package)
                                       <tr>
                                          ...
                                          <td> 
                                            @if($user_meta->setup == 1)
                                                @if($user_meta->edition == 1)
                                                    <a href="{{route('edit-package', ['id' => $package->id]) }}">Edit</a>
                                                @endif
                                            @endif
                                           </td>
                                       </tr>
        ...
        <script>
            function submitSearch() {
                const namePackage = document.getElementById('name_package').value;
                const namePackageDesc = document.getElementById('description').value;
                const baseUrl = '{{ route('package.index') }}';
                const queryString = new URLSearchParams({ name_package: namePackage,description: namePackageDesc }).toString();
