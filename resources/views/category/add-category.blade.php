...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Category</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
               ...
               <div class="grid grid-cols-12 gap-6 mt-5">
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        ...
                        <form method="post" @if(empty($query)) action="{{Route('save-category')}}" @endif  @if(!empty($query)) action="{{Route('edit-category-process')}}"   @endif  >
                           ...
                           <div class="preview">
                              ...
                              <div class="mt-2">
                                 <label for="regular-form-2" class="form-label">Select Shop</label>

                                 <select required name="shop" class="form-control" >   
                                 <option> Select Auto Shop </option>  
                                 @foreach($select as $rowselect)
                                 <option @if(!empty($query)) @if($rowselect->id ==$query->Name)) {{'selected'}}   @endif @endif > {{$rowselect->ShopName}}</option>
                                    @endforeach
                                 </select>
                              </div>
                              ...
                              <div class="mt-2">
                                 ...
                                 <label for="regular-form-2" class="form-label">Item Name</label>

                                 <input  required id="regular-form-2" @if(!empty($query)) value="{{$query->items}}" @endif name="Items[]" type="text"  class="form-control" placeholder="Product Name">

                                 @if(!empty($query)) 
                                    <input required type="hidden" name="id" value="{{$query->id}}">
                                 @endif

                              <div class="col-span-4 positon-relative">
                              <button class="addmoreproducts btn btn-danger" type="button"> + Add </button>
                              </div>
                              <div class="productsaddmore">
...
<th>Action</th>
                                ...
                                <td>{{$row->Des}}</td>
                                <td>
                                <a href="{{route('edit-category',['id'=>$row->id])}}"> Edit |  
                                <a href="{{route('delete-category',['id'=>$row->id])}}"> Delete  
                                </td>
...
$(".productsaddmore").append('<div class="'+x+'remeve">'+button+'<div class="mt-2"><label for="regular-form-2" class="form-label">Item Name</label><input  id="regular-form-2" name="Items[]" type="text" @if(!empty($query)) value="{{$query->Des}}" @endif class="form-control" placeholder="Product Name"><div class="col-span-4 positon-relative"><button data-id="'+x+'remeve" class="removepackage btn btn-danger" type="button"> Remove </button></div></div>');
x++;
});
